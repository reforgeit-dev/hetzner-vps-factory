...
- Generates SSH key for localhost access (added to root's `authorized_keys`)
...
3. The SSH key was already generated by this role — the wizard validates connectivity
