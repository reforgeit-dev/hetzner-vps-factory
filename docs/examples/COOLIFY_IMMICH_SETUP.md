...
1. Choose **"Deploy on this server"** (localhost) — Coolify takes a minute or two to validate the server, configure Docker, and start the proxy. Wait for it to finish before proceeding.
